    ...
    return (
        <div className='w-full h-full flex flex-col items-center justify-center gap-16'>
            ...
            <div className="flex flex-col justify-center items-center gap-10 sm:gap-16">
                <div className="text-white flex flex-row md:flex-col gap-4 xsm:gap-6 md:gap-10 items-center justify-center">
                    <div className='flex flex-col md:flex-row gap-4 xsm:gap-6 md:gap-10'>
                        <button className='font-bold xsm:text-[20px] capitalize border-2 hover:bg-blueColor transition-all delay-150 cursor-pointer w-36 xsm:w-48 md:w-52 lg:w-56 py-3'>app design</button>
                        <button className='font-bold xsm:text-[20px] capitalize border-2 hover:bg-blueColor transition-all delay-150 cursor-pointer w-36 xsm:w-48 md:w-52 lg:w-56 py-3'>graphic design</button>
                        <button className='font-bold xsm:text-[20px] capitalize border-2 hover:bg-blueColor transition-all delay-150 cursor-pointer w-36 xsm:w-48 md:w-52 lg:w-56 py-3'>motion design</button>
                    </div>
                    <div className='flex flex-wrap flex-col md:flex-row items-center justify-center gap-4 xsm:gap-6 md:gap-10 max-w-2xl'>
                        <button className='font-bold xsm:text-[20px] capitalize border-2 hover:bg-blueColor transition-all delay-150 cursor-pointer w-36 xsm:w-48 md:w-52 lg:w-56 py-3'>ux design</button>
                        <button className='font-bold xsm:text-[20px] capitalize border-2 hover:bg-blueColor transition-all delay-150 cursor-pointer w-36 xsm:w-48 md:w-52 lg:w-56 py-3'>web design</button>
                        <button className='font-bold xsm:text-[20px] capitalize border-2 hover:bg-blueColor transition-all delay-150 cursor-pointer w-36 xsm:w-48 md:w-52 lg:w-56 py-3'>marketing</button>
                    </div>
                </div>
