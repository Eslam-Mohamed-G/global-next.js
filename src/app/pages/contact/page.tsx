...
const Page = () => {
    return (
        <div className='w-1/2 flex items-center justify-center md:justify-end'>
            <img src="/img/contact-visual.png" alt="contact-visual"  className='w-full h-full object-cover absolute start-0 end-0 top-0 bottom-0'/>
            <div className='bg-black/80 text-white max-w-2xs text-center flex flex-col items-center justify-center gap-4 p-10 shadow-black drop-shadow-xl/50 shadow-2xl'>
